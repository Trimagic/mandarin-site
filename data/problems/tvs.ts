...
export const tvProblemPages: ProblemPageData[] = [
  {
    ...
    hero: hero("Нет изображения,", "но звук есть", "Чаще всего это подсветка, реже — блок питания или плата. Найдём причину и вернём картинку.", "На телевизоре нет изображения, но звук есть", { src: "/hero/tv-no-picture-sound-v1.png", alt: "Телевизор с тёмным экраном, фонарик высвечивает тусклое изображение" }),
    symptoms: {
  ...
  },
  {
    ...
    hero: hero("Телевизор", "не включается", "Чаще всего причина в блоке питания или материнской плате. Найдём неисправность и согласуем стоимость.", "Телевизор не включается", { src: "/hero/tv-wont-turn-on-v1.png", alt: "Телевизор с чёрным экраном без индикатора питания" }),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Телевизор включается", "и сразу выключается", "Проверим блок питания, подсветку и материнскую плату. Найдём, что вызывает защитное отключение.", "Телевизор включается и сразу выключается", { src: "/hero/tv-turns-off-v1.png", alt: "Экран телевизора гаснет в момент выключения, мигает индикатор" }),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Полосы на экране", "телевизора", "Если на экране нет трещин, причина часто в шлейфе или плате T-Con — их мы ремонтируем.", "Полосы на экране телевизора", { src: "/hero/tv-lines-on-screen-v1.png", alt: "Телевизор с вертикальными и горизонтальными полосами на экране" }),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Телевизор зависает", "и перезагружается", "Проверим прошивку, память и материнскую плату. Восстановим стабильную работу Smart TV.", "Телевизор зависает и перезагружается", { src: "/hero/tv-freezes-v1.png", alt: "Телевизор со значком перезагрузки на экране" }),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Нет звука", "на телевизоре", "Проверим динамики, усилитель на плате и настройки. Определим причину и вернём звук.", "Нет звука на телевизоре", { src: "/hero/tv-no-sound-v1.png", alt: "Телевизор со значком отключённого звука на экране" }),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
