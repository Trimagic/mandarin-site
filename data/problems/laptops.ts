...
export const laptopProblemPages: ProblemPageData[] = [
  {
    ...
    hero: hero("Ноутбук", "не включается", "Найдём причину: блок питания, разъём, аккумулятор, BIOS или плата. Согласуем стоимость до ремонта.", "Ноутбук не включается"),
    symptoms: {
  ...
  },
  {
    ...
    hero: hero("Ноутбук", "не заряжается", "Проверим адаптер, гнездо питания, аккумулятор и контроллер заряда. Согласуем стоимость до ремонта.", "Ноутбук не заряжается"),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Ноутбук", "сильно греется", "Чаще всего причина в пыли и высохшей термопасте. Почистим охлаждение и проверим температуры под нагрузкой.", "Ноутбук сильно греется"),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Ноутбук", "сильно шумит", "Определим источник шума: пыль, изношенный кулер, жёсткий диск или фоновая нагрузка.", "Ноутбук сильно шумит"),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Ноутбук", "медленно работает", "Определим причину: старый жёсткий диск, мало памяти, перегрев или программы. Подскажем, как ускорить.", "Ноутбук медленно работает"),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("Ноутбук", "сам выключается", "Проверим охлаждение, питание, аккумулятор и плату. Согласуем стоимость до ремонта.", "Ноутбук сам выключается"),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
  ...
  },
  {
    ...
    hero: hero("На ноутбуке", "нет изображения", "Проверим матрицу, шлейф, подсветку и видеочип. Определим причину и согласуем стоимость до ремонта.", "На ноутбуке нет изображения"),
    symptoms: {
      title: "Как проявляется неисправность",
      items: [
