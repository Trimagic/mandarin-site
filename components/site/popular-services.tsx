...
export function PopularServices() {
  return (
    <section id="prices" aria-labelledby="popular-services-heading" className="mx-auto w-full max-w-[1440px] scroll-mt-24 px-6 pb-10 xl:px-12">
        ...
        {services.map((service) => (
          ...
          >
            <div className="relative aspect-[3/2] overflow-hidden bg-[#e9e5df]">
              <Image src={`/services/${service.image}.png`} alt={service.alt} fill sizes="(min-width: 1440px) 210px, (min-width: 1280px) calc((100vw - 176px) / 6), calc((100vw - 80px) / 3)" className="object-cover" />
            </div>
